...
const routes = (
  <Route path="/" component={App} onEnter={willTransitionTo}>
    ...
    <Route
      path="bazaar"
      getComponent={(location, cb) => {
        System.import("components/Exchange/Bazaar")
          .then(loadRoute(cb))
          .catch(errorLoading);
      }}
    />
    ...
    <Route
      path="/explorer/fees"
      getComponent={(location, cb) => {
        System.import("components/Blockchain/FeesContainer")
          .then(loadRoute(cb))
          .catch(errorLoading);
      }}
    />
    ...
    <Route
      path="/swap"
      getComponent={(location, cb) => {
        System.import("components/Swap/SwapContainer")
          .then(loadRoute(cb))
          .catch(errorLoading);
      }}
    />
    ...
    <Route
      ...
      getComponent={(location, cb) => {
        System.import("components/Exchange/MarketsContainer")
          .then(loadRoute(cb))
          .catch(errorLoading);
      }}
    />
    ...
    <Route
      path="asset/:symbol"
      getComponent={(location, cb) => {
        System.import("components/Blockchain/AssetContainer")
          .then(loadRoute(cb))
          .catch(errorLoading);
      }}
    />
    ...
    >
      ...
      <Route
        path="orders"
        getComponent={(location, cb) => {
          System.import("components/Account/AccountOrders")
            .then(loadRoute(cb))
            .catch(errorLoading);
        }}
      />
    ...
    <Route
      path="gateway"
      getComponent={(location, cb) => {
        System.import("components/Gateway/Gateway")
          .then(loadRoute(cb))
          .catch(errorLoading);
      }}
    />
