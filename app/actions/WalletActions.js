...
import { TransactionBuilder, FetchChain } from "cybexjs";
  ...
  createAccountWithPassword(
    ...
    return new Promise((resolve, reject) => {
      ...
      if (registrar) {
        ...
        let create_account_promise = fetch(faucetAddress + "/register", {
          method: "post",
          mode: "cors",
          headers: {
    ...
    return dispatch => {
      return new Promise((resolve, reject) => {
        ...
        let p = Promise.all([unlock, account_lookup]).then(results => {
          ...
          tr.set_expire_seconds(30 * 60 + balance_claims.length);
