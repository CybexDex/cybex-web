  ...
  onSubmit() {
    if (
      ...
      if (!this.state.withdraw_address_is_valid) {
        ...
        const gateFee = parseFloat(
          String.prototype.replace.call(this.props.gateFee, /,/g, "")
        );
      ...
      options = (
        ...
        >
          {storedAddress.map(function(name, index) {
            return (
              <a key={index} onClick={this.onSelectChanged.bind(this, index)}>
                {name}
              </a>
            );
          }, this)}
      ...
      <form className="grid-block vertical full-width-content">
        <div className="grid-container">
          ...
          <div className="content-block">
            ...
            <div className="blocktrades-position-options">{options}</div>
            {invalid_address_message}
          </div>
