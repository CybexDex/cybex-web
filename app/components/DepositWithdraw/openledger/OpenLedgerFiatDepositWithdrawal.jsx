...
class OpenLedgerFiatDepositWithdrawal extends React.Component {
  ...
  constructor(props) {
    ...
    let json_rpc_request = {
      ...
      params: { CybexAccountName: this.props.account.get("name") }
    };
      ...
      <table className="table">
        ...
        <tbody>
          <OpenLedgerFiatDepositWithdrawCurrency
            ...
            deposit_allowed={
              this.state.allowedFiatCurrencies.deposit.indexOf("USD") > -1
            }
            withdraw_allowed={
              this.state.allowedFiatCurrencies.withdraw.indexOf("USD") > -1
            }
          />
          <OpenLedgerFiatDepositWithdrawCurrency
            rpc_url={this.props.rpc_url}
            ...
            deposit_allowed={
              this.state.allowedFiatCurrencies.deposit.indexOf("EUR") > -1
            }
            withdraw_allowed={
              this.state.allowedFiatCurrencies.withdraw.indexOf("EUR") > -1
            }
          />
          <OpenLedgerFiatDepositWithdrawCurrency
            rpc_url={this.props.rpc_url}
            ...
            deposit_allowed={
              this.state.allowedFiatCurrencies.deposit.indexOf("CNY") > -1
            }
            withdraw_allowed={
              this.state.allowedFiatCurrencies.withdraw.indexOf("CNY") > -1
            }
          />
        </tbody>
      </table>
