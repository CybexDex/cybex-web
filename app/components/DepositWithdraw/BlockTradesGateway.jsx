  ...
  render() {
    ...
    let issuers = {
      ...
      openledger: {
        ...
        id: "1.2.96397",
        support: "https://openledger.freshdesk.com"
      }
    };
          ...
          <div className="medium-6 medium-offset-1">
            ...
            <div style={{ paddingBottom: 15 }}>
              <ul className="button-group segmented no-margin">
                <li className={action === "deposit" ? "is-active" : ""}>
                  <a onClick={this.changeAction.bind(this, "deposit")}>
                    <Translate content="gateway.deposit" />
                  </a>
                </li>
                <li className={action === "withdraw" ? "is-active" : ""}>
                  <a onClick={this.changeAction.bind(this, "withdraw")}>
          ...
          <div>
            <div style={{ marginBottom: 15 }}>
              ...
              <div>
                ...
                <a
                  href={
                    (issuer.support.indexOf("@") === -1 ? "" : "mailto:") +
                    issuer.support
                  }
                >
                  {issuer.support}
            ...
            {coin && coin.symbol ? (
              <TransactionWrapper
                asset={coin.symbol}
                fromAccount={
                  isDeposit ? issuer.id : this.props.account.get("id")
                }
