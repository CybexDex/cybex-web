...
class PriceChart extends React.Component {
  shouldComponentUpdate(nextProps, nextState) {
    ...
    if (
      chart &&
      !utils.are_equal_shallow(nextProps.indicators, this.props.indicators)
    ) {
      let changed, added;
        ...
        <div className="exchange-bordered" style={{ margin: 10 }}>
          <div className="exchange-content-header">
            ...
            <div className="float-right">
              <div
                style={{ marginBottom: -3, marginTop: -6, padding: "3px 8px" }}
                className="inline-block button outline clickable"
                onClick={this.props.onChangeSize.bind(this, false)}
              >
                -
              </div>
              <div
                style={{ marginBottom: -3, marginTop: -6, padding: "3px 8px" }}
                className="inline-block button outline clickable"
                onClick={this.props.onChangeSize.bind(this, true)}
              >
                +
              </div>
            </div>
