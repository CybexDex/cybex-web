            ...
            <div className="grid-block vertical no-overflow no-padding">
              ...
              <div className="grid-block no-padding buy-sell-row">
                ...
                <div
                  ...
                  style={{ paddingLeft: feeAssets.length !== 1 ? 0 : 5 }}
                >
                  <select
                    style={
                      feeAssets.length === 1 ? { background: "none" } : null
                    }
                    disabled={feeAssets.length === 1}
                    value={feeAssets.indexOf(this.props.feeAsset)}
                    className={
                      "form-control" +
                      (feeAssets.length !== 1 ? " buysell-select" : "")
                    }
                        ...
                        >
                          ...
                          >
                            <PriceText
                              ...
                              base={base}
                            />{" "}
                            <AssetName name={base.get("symbol")} />/<AssetName
