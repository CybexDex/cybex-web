      ...
      <thead>
        <tr>
          <th style={{ textAlign: "center" }}>
            <Translate content="exchange.price" />&nbsp;{baseSymbol ? (
          ...
          <th style={{ textAlign: "center" }}>
            <Translate content="transfer.amount" />&nbsp;{quoteSymbol ? (
              <span className="header-sub-title">
          ...
          <th style={{ textAlign: "center" }}>
            <Translate content="transaction.settlement_date" />&nbsp;<span
...
class SettleOrderRow extends React.Component {
  ...
  render() {
    ...
    return (
      <tr>
        <td>
          {utils.format_number(order.getPrice(), quote.get("precision"))}{" "}
          {amountSymbol}
        </td>
        <td>
          <FormattedAsset
            ...
            asset={
              order[!order.isBid() ? "amountForSale" : "amountToReceive"]()
                .asset_id
            }
          />
        </td>
          ...
          <div className="exchange-bordered">
            ...
            >
              <table className="table order-table text-right table-hover">
                ...
                />
                <tbody ref="orders">{activeOrders}</tbody>
              </table>
            </div>
          </div>
        </div>
