  ...
  render() {
    ...
    return (
      <div className="grid-block page-layout market-layout">
                  ...
                  <PriceChartD3
                    ...
                    height={
                      this.state.width > 848 ?
                        this.refs.center ?
                          this.refs.center.clientHeight - 50 :
                          chartHeight :
                        chartHeight - 125
                    }
        ...
        <div
          className="grid-block shrink right-column small-12 no-overflow vertical"
        >
          {/* Market History */}
          <div className="grid-block no-padding vertical orders-wrapper with-shadow">
            ...
            {currentInfoTab.key === INFO_TAB_OPEN_SETTLE_ORDERS && (base.get("id") === "1.3.0" || quote.get("id") === "1.3.0")
              ? (<OpenSettleOrders
                withHeader={false}
                key="settle_orders"
