...
import {
    ChartCanvas, Chart, series, scale, coordinates, tooltip, axes,
    indicator, helper, interactive
...
class CandleStickChartWithZoomPan extends React.Component {
    ...
    _renderVolumeChart(chartMultiplier) {
        ...
        const { axisLineColor, volumeColor, indicatorLineColor, negativeColor, positiveColor } = this._getThemeColors();
    ...
    _renderCandleStickChart(chartMultiplier, maCalcs) {
        ...
        const { height, width, showVolumeChart, indicators, enableChartClamp, onMouseMove } = this.props;
        ...
        return <Chart
            id={1}
            height={height * ((chartMultiplier ? 0.92 : 0.9) - (0.20 * chartMultiplier))}
