    ...
    render() {
        ...
        return (
            <div className={this.props.className}>
                <div className="flex-wrapper flex-wrapper-main flex-column small-12 " style={{ height: "100%", maxHeight: 720 }}>
                    ...
                    <div className="grid-block shrink left-orderbook-header market-right-padding-only">
                        <table className="table table-4 order-table fixed-table market-right-padding">
                            <thead>
                                <tr>
                                    <th className="text-center"><Translate className="header-sub-title" content="exchange.price" /></th>
                                    <th className="text-center"><span className="header-sub-title"><AssetName dataPlace="top" name={quoteSymbol} /></span></th>
                                    <th className="text-center"><span className="header-sub-title"><AssetName dataPlace="top" name={baseSymbol} /></span></th>
                                    <th className="text-center"><Translate className="header-sub-title" content="explorer.block.date" /></th>
                                </tr>
                            </thead>
                        </table>
                    </div>
