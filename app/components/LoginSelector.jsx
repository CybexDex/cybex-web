                ...
                <div className="grid-block no-margin no-padding vertical medium-horizontal no-overflow login-selector">
                    <div className="box small-12 medium-5 large-5">
                        ...
                        <div className="fix-bottom">
                            ...
                            <div className="button" onClick={this.onSelect.bind(this, "wallet")}>
                    ...
                    <div className="box small-12 medium-5 large-5 vertical">
                        ...
                        <div className="fix-bottom">
                            <Translate content="wallet.already_have_account" component="p" />
                            <ul className="list">
                                <li className="link">
                                    <Link className="create-account" onClick={() => {
                            ...
                            <Translate content="or" component="p" />
                            <div className="button" onClick={this.onSelect.bind(this, "password")}>
