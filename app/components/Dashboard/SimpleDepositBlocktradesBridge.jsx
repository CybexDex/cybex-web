...
class SimpleDepositBlocktradesBridge extends React.Component {
  ...
  _renderDeposit() {
    ...
    const hasMemo =
      receive_address && "memo" in receive_address && receive_address.memo;
      ...
      <div className={!addressValue ? "no-overflow" : ""}>
        ...
        <div className="SimpleTrade__withdraw-row">
          <div className="grid-block">
            ...
            <span
              data-tip={counterpart.translate("tooltip.bridge_TRADE")}
                ...
                <div className="grid-block">
                  ...
                  {aboveLimit ? (
                    <div
                      ...
                      data-tip={counterpart.translate("tooltip.over_limit")}
                    >
                ...
                <div className="inline-label input-wrapper">
                  ...
                  <div className="form-label select floating-dropdown">
                    <FloatingDropdown
                      ...
                      values={bridgeAssets.reduce((map, a) => {
                        if (a) map[a] = a;
                        return map;
                      }, {})}
                  ...
                  <input
                    ...
                    value={
                      (this.state.depositLimit &&
                        parseFloat(this.state.depositLimit).toFixed(4)) ||
                      0
                    }
                  />
            ...
            >
              ...
              <div className="grid-block SimpleTrade__deposit-info">
                <div className="copyIcon">
                  <CopyButton
                    text={addressValue}
                    className={"SimpleTrade__copyIcon"}
                  />
                </div>
    ...
    const applyBalanceButton = isDeposit ? (
      ...
      <button
        ...
        onClick={this._updateAmount.bind(
          this,
          !currentBalance ? 0 : parseInt(currentBalance.get("balance"), 10)
        )}
      >
        <Icon name="clippy" />
      </button>
  ...
  render() {
    ...
    let logo = require("assets/cybex-logo.png");

    return (
      <div className="SimpleTrade__modal">
        <div className="Modal__header" style={{ background: "none" }} />
        ...
        >
          <div style={{ textAlign: "center" }}>
            <img style={{ margin: 0, height: 80 }} src={logo} />
            <br />
            <p
              style={{
                fontSize: "1.8rem",
