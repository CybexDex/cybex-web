...
class DepositWithdrawContent extends DecimalChecker {
  ...
  _renderWithdraw() {
    ...
    return (
      <div>
        <p>
          <Translate content="gateway.withdraw_funds" asset={assetName} />
        </p>
          ...
          <div className="inline-label input-wrapper">
            ...
            <div className="form-label select floating-dropdown">
              <div className="dropdown-wrapper inactive">
                <div>
                  {feeAsset ? (
                    <AssetName name={feeAsset.get("symbol")} />
                  ) : null}
                </div>
              </div>
            </div>
        ...
        <div className="SimpleTrade__withdraw-row">
          ...
          <div className="inline-label input-wrapper">
            ...
            <div className="form-label select floating-dropdown">
              <div className="dropdown-wrapper inactive">
                <div>
                  <AssetName name={this.props.asset.get("symbol")} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="inline-label input-wrapper">
            ...
            <div className="form-label select floating-dropdown">
              <div className="dropdown-wrapper inactive">
                <div
                  data-place="right"
                  data-tip={counterpart.translate("tooltip.withdraw_address", {
                    asset: assetName
                  })}
                >
                  ?
      ...
      <div className={!addressValue ? "no-overflow" : ""}>
        ...
        <div className="button-group SimpleTrade__withdraw-row">
          <button
            tabIndex={tabIndex++}
            className="button"
            onClick={requestDepositAddress.bind(null, this._getDepositObject())}
            type="submit"
          >
