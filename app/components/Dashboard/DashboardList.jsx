...
class DashboardList extends React.Component {
          ...
          return (
            <tr key={accountName}>
              ...
              <td
                ...
                onClick={this._goAccount.bind(this, `${accountName}/overview`)}
                className={isMyAccount ? "my-account" : ""}
              >
                <span className={isLTM ? "lifetime" : ""}>{accountName}</span>
              </td>
              <td
                onClick={this._goAccount.bind(this, `${accountName}/orders`)}
  ...
  render() {
    ...
    let hiddenAccounts = showIgnored
      ? this._renderList(this.props.ignoredAccounts)
      : null;
    ...
    return (
      <div style={this.props.style}>
        {!this.props.compact ? (
          <section
            style={{ paddingLeft: "5px", width: "100%", position: "relative" }}
          >
            <input
            ...
            />
            {this.props.ignoredAccounts.length ? (
              <div
            ...
            <thead>
              <tr>
                <th
                  ...
                  className="clickable"
                >
                  <Icon className="grey-star" name="fi-star" />
                </th>
                <th
                  style={{ textAlign: "left", paddingLeft: 10 }}
