...
class AccountAssetUpdate extends React.Component {
  ...
  _validateEditFields(new_state) {
    ...
    let isValid =
      !errors.max_supply && !errors.base_asset && !errors.quote_asset;
  ...
  render() {
    ...
    let validClaim =
      claimFeesAmount > 0 &&
      utils.get_asset_precision(asset.get("precision")) * claimFeesAmount <=
        unclaimedBalance;
            ...
            <Tab title="explorer.asset.fee_pool.title">
              <div className="small-12 large-8 grid-content">
                ...
                <div style={{ paddingBottom: "1rem" }}>
                  ...
                  <span>: </span>
                  <FormattedAsset
                    amount={asset.getIn(["dynamic", "fee_pool"])}
                    asset={"1.3.0"}
                  />
                </div>
                ...
                <div style={{ paddingBottom: "1rem" }}>
                  ...
                  <FormattedAsset
                    amount={asset.getIn(["dynamic", "accumulated_fees"])}
                    asset={asset.get("id")}
                  />
                </div>
                ...
                <div style={{ paddingTop: "0.5rem" }}>
                  <hr />
                  <button
                    className={classnames("button", { disabled: !validClaim })}
