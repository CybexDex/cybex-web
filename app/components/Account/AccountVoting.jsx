  ...
  render() {
    ...
    const saveText = (
      <div
        ...
        style={{
          display: this.isChanged() ? "block" : "none",
          color: "red",
          padding: "0.85rem",
          fontSize: "0.9rem"
        }}
      ...
      <div className="grid-content app-tables" ref="appTables">
        <div className="content-block small-12">
          <div className="generic-bordered-box">
            ...
            >
              <Tab disabled title={proxyInput} className="total-value" />
                ...
                <div className="hide-selector">
                  ...
                  {expiredWorkers.length ? (
                    <div
                      ...
                      onClick={
                        !showExpired
                          ? this._setWorkerTableIndex.bind(this, 2)
                          : () => {}
                      }
                    >
                    ...
                    <thead>
                      <tr>
                        ...
                        <th style={{ textAlign: "left" }}>
                          <Translate content="account.votes.total_budget" /> (<AssetName
                            name={preferredUnit}
                          />)
                        </th>
