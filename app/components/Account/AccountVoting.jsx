...
class AccountVoting extends React.Component {
    ...
    render() {
        ...
        const saveText = (
            <div className="inline-block" style={{ display: this.isChanged() ? "block" : "none", color: "red", padding: "0.85rem", fontSize: "0.9rem" }}>
                        ...
                        >
                            ...
                            <Tab title="account.votes.workers_short">
                                ...
                                <div className="hide-selector">
                                    ...
                                    <div style={{ paddingLeft: 10 }} className={cnames("hide-selector-item", { inactive: workerTableIndex !== 0 })} onClick={this._setWorkerTableIndex.bind(this, 0)}>
                                        {counterpart.translate("account.votes.new", { count: newWorkers.length })}
                                    </div>
                                    <div className={cnames("hide-selector-item", { inactive: workerTableIndex !== 1 })} onClick={this._setWorkerTableIndex.bind(this, 1)}>
                                        {counterpart.translate("account.votes.active", { count: workers.length })}
                                    </div>

                                    {expiredWorkers.length ? <div className={cnames("hide-selector-item", { inactive: !showExpired })} onClick={!showExpired ? this._setWorkerTableIndex.bind(this, 2) : () => { }}>
