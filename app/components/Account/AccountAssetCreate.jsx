      ...
      <div className="grid-block">
        <div className="grid-content">
          ...
          <Tabs
            setting="overviewTab"
            segmented={false}
            className="overview-tabs with-shadow"
            style={{ width: "100%" }}
                ...
                {isVestingAsset && (
                  <div className="form-group grid-block grid-x-padding full-container">
                    ...
                    <Translate
                      ...
                      className="left-label small-12 medium-12"
                      content="account.user_issued_assets.vesting_period"
                    />
                    <Period
                      className="period-horizontal"
                      defaultPeriod={this.state.update.vesting_period}
                      name="create"
                      onPeriodChange={this._onPeriodChange.bind(
                        this,
                        "vesting_period"
                      )}
                    />
