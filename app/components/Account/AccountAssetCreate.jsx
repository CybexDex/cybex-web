...
class AccountAssetCreate extends React.Component {
    ...
    _createAsset(e) {
        ...
        let { update, flagBooleans, permissionBooleans, core_exchange_rate,
            isBitAsset, is_prediction_market, bitasset_opts, isVestingAsset } = this.state;
    ...
    _validateEditFields(new_state, isExt) {
        let errors = {
            max_supply: null
        };
    ...
    _onToggleVestingAsset() {
        this.setState(prevState => {
            let isVestingAsset = !prevState.isVestingAsset;
            return {
                isVestingAsset
            };
        });
                            ...
                            <div className="small-12 grid-content">
                                ...
                                {/* <div className="grid-block full-container switch-container">
                                    ...
                                    <div className="small-9 text-right">
                                        <div className="switch">
                                            <input id="isVestingAsset" type="checkbox" checked={isVestingAsset} onChange={this._onToggleVestingAsset.bind(this)} />
                                ...
                                </div> */}
                                {
                                    ...
                                    <div className="form-group grid-block grid-x-padding full-container">
                                        {/* <label htmlFor="" className="small-12 medium-6">
                                ...
                                <div className="grid-block full-container switch-container">
                                    <Translate component="div" className="small-3" content={"account.user_issued_assets.mpa"} />
                                    <div className="small-9 text-right">
                                        <div className="switch">
                                            <input id="isBitAsset" type="checkbox" checked={isBitAsset} onChange={this._onToggleBitAsset.bind(this)} />
                                            <label htmlFor="isBitAsset" />
                                        </div>
                                    </div>
                                </div>
                                {
                                    isBitAsset &&
                                    <div className="grid-block full-container switch-container">
                                        <Translate component="div" className="small-3" content={"account.user_issued_assets.pm"} />
                                        <div className="small-9 text-right">
                                            <div className="switch">
                                                <input id="predictionMarket" type="checkbox" checked={is_prediction_market} onChange={this._onTogglePM.bind(this)} />
                                                <label htmlFor="predictionMarket" />
                                            </div>
                                        </div>
                                    </div>
                                }
