    ...
    if (this.state.tabvm_memo) {
      ...
      setTimeout(() => {
        ...
        try {
          ...
          let verified = false;
          try {
            verified = Signature.fromHex(memo.signature).verifyBuffer(
              memo.signed,
              PublicKey.fromPublicKeyString(memo.meta.key)
            );
          } catch (err) {
            ...
            <Tab title="account.signedmessages.verifymessage">
              <div className="grid-content" style={{ overflowX: "hidden" }}>
                ...
                <span>
                  ...
                  {this.state.tabvm_verified &&
                    this.state.tabvm_memo_verified !== null && (
                      <div>
                        <br />
                        <div style={{ color: "gray" }}>
                          Verified message from{" "}
                          {this.state.tabvm_memo_verified.meta.account}, signed
                          on {this.state.tabvm_memo_verified.meta.timestamp}:<br />
