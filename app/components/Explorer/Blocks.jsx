    ...
    render() {
        ...
        return (
            <div ref="outerWrapper" className="block-wrapper grid-block page-layout">
                ...
                <div className="block-left bgcolor-primary with-shadow">
                    ...
                    <div className="grid-block text-center small-6">
                        <div className="grid-content no-overflow clear-fix">
                            ...
                            <h2 className="txtlabel cancel" style={{ fontWeight: "100" }}>
                    ...
                    <div className="grid-block text-center small-6">
                        <div className="grid-content no-overflow">
                            <div className="text-left txtlabel subheader">
                                <Translate component="span" content="explorer.blocks.trx_per_block" />
                            </div>
                    ...
                    <div className="grid-block text-center small-6">
                        <div className="grid-content no-overflow">
                            <div className="text-left txtlabel subheader"><Translate component="span" content="explorer.blocks.block_times" /></div>
                ...
                <div ref="transactionsBlock" className="block-right show-for-medium vertical grid-block no-overflow">
