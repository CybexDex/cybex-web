  ...
  render() {
    ...
    let pm = assets
      .filter(a => {
        ...
        return (
          a.bitasset_data &&
          a.bitasset_data.is_prediction_market &&
          (a.symbol.toLowerCase().indexOf(this.state.filterPM.toLowerCase()) !==
            -1 ||
            description.main
              .toLowerCase()
              .indexOf(this.state.filterPM.toLowerCase()) !== -1)
        );
      })
      .map(asset => {
        let description = assetUtils.parseDescription(
    ...
    return (
      <div className="grid-block vertical">
        <div className="grid-block page-layout vertical readable container">
