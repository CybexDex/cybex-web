...
export namespace LockC {
  ...
  export enum LockCPersonalState {
    Uninit,
    Basic,
    Survey,
    Lock,
  ...
  export class LockCInfo {
    state: LockCPersonalState = LockCPersonalState.Basic;
    sum = 0;
...
export const edgeTx = new Serializer("LockCTx", {
  op: edgeOp,
  expiration: time_point_sec
});
export const LockCRefer = "$#EDGE_REFER";
// import { Serializer } from "../cybex/serializer";
export namespace LockCOps {
