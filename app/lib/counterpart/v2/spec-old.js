...
describe('translate', function() {
  ...
  describe('when called', function() {
    describe('with a non-empty string or an array as first argument', function() {
      ...
      describe('with pure strings as keys', function() {
        it('works', function() {
          instance.registerTranslations('de', { 'Hello, %(user)s!': 'Hallo %(user)s!' });
          assert.deepEqual(instance.translate('Hello, %(user)s!', { locale: 'de', user: 'Martin' }), 'Hallo Martin!');
        });
      });
