      ...
      <div className="wrapper">
        ...
        <div className="vertical grid-frame">
          ...
          <div className="grid-block">
            <Panel
              id="sidebar"
              className="medium-3 large-2 medium-grid-block sidebar vertical"
            >
              <div className="grid-content collapse">
                ...
                <section>
                  <ul className="menu-bar vertical">
                    <li>
                      <Link to="install">Installation &amp; Usage</Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="offcanvas">Off-canvas Menu</Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="interchange">Interchange</Link>
                    </li>
                    <li>
            ...
            <div className="medium-9 large-10 grid-content">
              <div className="grid-container main-docs-section">
                <Trigger toggle="sidebar">
                  <a className="small secondary expand button hide-for-medium">
                    Show Components
                  </a>
                </Trigger>
                <RouteHandler />
