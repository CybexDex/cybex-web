    ...
    return (
      <div>
        ...
        <h4 className="subheader">
          A simple JavaScript solution for responsive images and content.
          Interchange uses media queries to dynamically load responsive content
          that is appropriate for different users' browsers
        </h4>
        <hr />
