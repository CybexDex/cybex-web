  ...
  render: function() {
    return (
      <div>
        ...
        <h2>Panel</h2>
        <h4 className="subheader">panel</h4>
        <hr />
        ...
        <h4>Panel Trigger</h4>
        <p>
          Place the markup for panel component inside the block where panel
          should be revealed. You can trigger the panel with actions such as
          open, toggle, hardToggle using Trigger component
        </p>
        <div className="grid-block">
          <div className="grid-content">
            <Highlight innerHTML={true} languages={["xml"]}>
